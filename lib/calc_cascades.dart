...
class ValTable {
  List<List<double>> as;
  List<List<double>> bs;
  ValTable({required this.as, required this.bs});
}
...
class AsAndBs {
  ...
  List<List<double>> bs;
  AsAndBs(
      {required List<List<double>> this.as,
      required List<List<double>> this.bs});
}
